...
PythonistaScopeGlobal = 'global'
PythonistaScopeEditor = 'editor'

UIKeyCommand = ObjCClass('UIKeyCommand')

_key_commands = {
	PythonistaScopeGlobal: [],
	PythonistaScopeEditor: []
}
...
def _zrzka_keyCommands(_self, _cmd):
	...
	# TODO Find a way how check what part of Pythonista is visible/active
	commands.extend(_key_commands[PythonistaScopeGlobal])
	commands.extend(_key_commands[PythonistaScopeEditor])
