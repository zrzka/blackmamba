...
class PickerView(View):
    def __init__(self):
        ...
        self._handlers.append(register_key_event_handler(UIEventKeyCodeEnter, handle_shift_enter, modifier_flags=UIKeyModifierShift))
        self._handlers.append(register_key_event_handler(UIEventKeyCodeEscape, handle_escape))
        self._handlers.append(register_key_event_handler(UIEventKeyCodeLeftSquareBracket, handle_escape, modifier_flags=UIKeyModifierControl))
